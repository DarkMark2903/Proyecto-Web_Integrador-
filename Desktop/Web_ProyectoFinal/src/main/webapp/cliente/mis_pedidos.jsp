    ...
    <main class="container my-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="mb-4 fw-bold">Mis Pedidos</h1>
                <p class="lead text-golden">Revisa el historial y estado de tus compras.</p>
                <hr>
            </div>
        </div>
                    ...
                    <c:choose>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover align-middle">
                                    <thead class="table-dark">
                                        <tr>
                                            <th>ID</th><th>Fecha</th><th>Total</th><th>Estado</th><th>Detalle</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="pedido" items="${pedidos}">
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-outline-dark" data-bs-toggle="modal" data-bs-target="#modalPedido${pedido.id_pedido}"><i class="bi bi-eye"></i> Ver</button>
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="modal-content bg-dark text-white">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="list-group mb-3">
                                                                <%-- VARIABLE LOCAL PARA CALCULAR SUBTOTAL INTERNO DEL MODAL --%>
                                                                ...
                                                                <c:forEach var="item" items="${pedido.detalles}">
                                                                    <div class="list-group-item bg-secondary text-white border-0 mb-2 rounded d-flex align-items-center">
                                                                        <img src="${pageContext.request.contextPath}/img/${item.imagen}" alt="Prod" style="width: 50px; height: 50px; object-fit: contain;" class="bg-white rounded me-3">
                                                                        ...
                                                                        <c:set var="subtotalPedido" value="${subtotalPedido + item.subtotal}" />
                                                                    </div>
                                                                </c:forEach>
                                                            </div>
                                                            ...
                                                            <div class="border-top border-secondary pt-2">
                                                                <div class="d-flex justify-content-between small text-muted">
                                                                    ...
                                                                    <span>S/ <fmt:formatNumber value="${subtotalPedido}" pattern="#0.00" /></span>
                                                                </div>
                                                                <div class="d-flex justify-content-between small text-muted">
                                                                    <span>IGV (18%):</span>
                                                                    <span>S/ <fmt:formatNumber value="${subtotalPedido * 0.18}" pattern="#0.00" /></span>
                                                                </div>
                                                                <div class="d-flex justify-content-between small text-muted">
                                                                    <span>Envío:</span>
                                                                    <span>S/ 15.00</span>
                                                                ...
                                                                <div class="d-flex justify-content-between mt-2">
                                                                    <h5 class="text-warning fw-bold">Total Pagado:</h5>
                                                                    <h5 class="text-warning fw-bold">S/ <fmt:formatNumber value="${pedido.total}" pattern="#0.00" /></h5>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <c:otherwise>
                            <div class="text-center py-5">
                                <i class="bi bi-box-seam display-4 text-golden"></i>
                                <h4 class="mt-3 text-golden">Aún no has realizado ningún pedido.</h4>
                                <a href="${pageContext.request.contextPath}/catalogo" class="btn btn-warning mt-3">¡Empieza a Comprar!</a>
                            </div>
                        </c:otherwise>
                    </c:choose>
