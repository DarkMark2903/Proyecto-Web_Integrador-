                        ...
                        <table class="table table-dark table-hover align-middle">
                            ...
                            <tbody>
                                <c:choose>
                                                    ...
                                                    <div class="modal-content" style="background-color: #2b2b2b; color: #fff;">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="border-top border-secondary pt-2">
                                                                <div class="d-flex justify-content-between small text-muted"><span>Subtotal:</span><span>S/ <fmt:formatNumber value="${subtotalCalc}" pattern="#0.00" /></span></div>
                                                                <div class="d-flex justify-content-between small text-muted"><span>IGV (18%):</span><span>S/ <fmt:formatNumber value="${subtotalCalc * 0.18}" pattern="#0.00" /></span></div>
                                    ...
                                    <c:otherwise><tr><td colspan="6" class="text-center text-muted">No hay ventas registradas.</td></tr></c:otherwise>
                                </c:choose>
                            </tbody>
                        </table>
                    </div>
